...
--
-- 表的结构 `rrhbt2t8888_apply`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_apply` (
...
--
-- 表的结构 `rrhbt2t8888_area_china`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_area_china` (
...
--
-- 表的结构 `rrhbt2t8888_area_world`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_area_world` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户订单表',
  `type` smallint(1) DEFAULT '0',
  `name` varchar(30) DEFAULT '',
  `parent_id` int(11) DEFAULT '0' COMMENT '状态修改时间',
...
--
-- 表的结构 `rrhbt2t8888_attribute`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_attribute` (
...
--
-- 表的结构 `rrhbt2t8888_attrtype`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_attrtype` (
...
--
-- 表的结构 `rrhbt2t8888_backupdatabase`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_backupdatabase` (
...
--
-- 表的结构 `rrhbt2t8888_cart`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_cart` (
...
--
-- 表的结构 `rrhbt2t8888_case`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_case` (
...
--
-- 表的结构 `rrhbt2t8888_comment`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_comment` (
...
--
-- 表的结构 `rrhbt2t8888_download`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_download` (
...
--
-- 表的结构 `rrhbt2t8888_drrz`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_drrz` (
...
--
-- 表的结构 `rrhbt2t8888_financial`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_financial` (
...
--
-- 表的结构 `rrhbt2t8888_goods`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_goods` (
...
--
-- 表的结构 `rrhbt2t8888_goodsaction`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_goodsaction` (
...
--
-- 表的结构 `rrhbt2t8888_goodsattr`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_goodsattr` (
...
--
-- 表的结构 `rrhbt2t8888_goodstype`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_goodstype` (
...
--
-- 表的结构 `rrhbt2t8888_hiring`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_hiring` (
...
--
-- 表的结构 `rrhbt2t8888_images`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_images` (
...
--
-- 表的结构 `rrhbt2t8888_info`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_info` (
...
--
-- 表的结构 `rrhbt2t8888_infotype`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_infotype` (
...
--
-- 表的结构 `rrhbt2t8888_infoweb`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_infoweb` (
...
--
-- 表的结构 `rrhbt2t8888_integral`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_integral` (
...
CREATE TABLE IF NOT EXISTS `rrhbt2t8888_ip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_jsbz`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_jsbz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_link`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_link` (
...
--
-- 表的结构 `rrhbt2t8888_logusers`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_logusers` (
...
--
-- 表的结构 `rrhbt2t8888_member`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_member` (
...
--
-- 转存表中的数据 `rrhbt2t8888_member`
--

INSERT INTO `rrhbt2t8888_member` (`MB_ID`, `MB_time`, `MB_loginTime`, `MB_loginNum`, `MB_loginIP`, `MB_realname`, `MB_username`, `MB_userpwd`, `MB_userKey`, `MB_right`, `MB_userGroup`, `MB_rightStr`, `MB_itemNum`) VALUES
(27, NULL, NULL, 0, NULL, NULL, 'admin', 'e10adc3949ba59abbe56e057f20f883e', NULL, 1, 0, NULL, 20),
(39, NULL, NULL, 0, NULL, NULL, 'abqiang520', '5c67af1abce23ba41992576d94a3041b', NULL, 1, 0, NULL, 20);

-- --------------------------------------------------------

--
-- 表的结构 `rrhbt2t8888_memberlog`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_memberlog` (
...
--
-- 表的结构 `rrhbt2t8888_menufile`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_menufile` (
...
--
-- 表的结构 `rrhbt2t8888_menutree`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_menutree` (
...
--
-- 表的结构 `rrhbt2t8888_message`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_message` (
...
--
-- 表的结构 `rrhbt2t8888_mobmsgset`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_mobmsgset` (
...
--
-- 表的结构 `rrhbt2t8888_order`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_order` (
...
--
-- 表的结构 `rrhbt2t8888_orderinte`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_orderinte` (
...
--
-- 表的结构 `rrhbt2t8888_orderstatus`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_orderstatus` (
...
--
-- 表的结构 `rrhbt2t8888_pai`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_pai` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_pin`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_pin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user` varchar(255) NOT NULL,
  `pin` varchar(255) DEFAULT NULL,
  `zt` varchar(255) DEFAULT NULL,
...
--
-- 表的结构 `rrhbt2t8888_ppdd`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_ppdd` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_ppdd_ly`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_ppdd_ly` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_regusers`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_regusers` (
...
--
-- 表的结构 `rrhbt2t8888_service`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_service` (
...
--
-- 表的结构 `rrhbt2t8888_shipping`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_shipping` (
...
--
-- 表的结构 `rrhbt2t8888_shopsj`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_shopsj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_shopsys`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_shopsys` (
...
--
-- 表的结构 `rrhbt2t8888_single`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_single` (
...
--
-- 表的结构 `rrhbt2t8888_sysadmin`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_sysadmin` (
...
--
-- 表的结构 `rrhbt2t8888_sysimages`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_sysimages` (
...
--
-- 表的结构 `rrhbt2t8888_system`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_system` (
  `SYS_ID` int(11) NOT NULL AUTO_INCREMENT,
  `SYS_theme` varchar(100) DEFAULT NULL,
  `SYS_address` varchar(200) DEFAULT NULL,
  `SYS_postCode` varchar(50) DEFAULT NULL,
...
--
-- 表的结构 `rrhbt2t8888_taobaoset`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_taobaoset` (
...
--
-- 表的结构 `rrhbt2t8888_task`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_task` (
  `MA_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '前台提交信息，留言、申请等',
  `MA_type` varchar(30) DEFAULT '' COMMENT '数据类型',
  `MA_theme` varchar(60) DEFAULT '' COMMENT '留言主题',
  `MA_time` datetime DEFAULT NULL COMMENT '提交时间',
...
--
-- 表的结构 `rrhbt2t8888_tgbz`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_tgbz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zffs1` int(8) NOT NULL DEFAULT '0',
  `zffs2` int(8) NOT NULL DEFAULT '0',
  `zffs3` int(8) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `rrhbt2t8888_tixian`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_tixian` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `rrhbt2t8888_topup`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_topup` (
...
--
-- 表的结构 `rrhbt2t8888_upfile`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_upfile` (
...
--
-- 表的结构 `rrhbt2t8888_user`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_user` (
...
--
-- 转存表中的数据 `rrhbt2t8888_user`
--

INSERT INTO `rrhbt2t8888_user` (`UE_ID`, `UE_img`, `UE_account`, `UE_accName`, `sfjl`, `zcr`, `UE_Faccount`, `UE_verMail`, `UE_check`, `UE_actiCode`, `UE_password`, `UE_question`, `UE_question2`, `UE_question3`, `UE_answer`, `UE_answer3`, `UE_answer2`, `UE_regTime`, `UE_regIP`, `UE_nowTime`, `UE_nowIP`, `UE_lastTime`, `UE_lastIP`, `UE_logNum`, `UE_status`, `UE_level`, `UE_note`, `UE_integral`, `UE_money`, `UE_sum`, `UE_info`, `UE_secpwd`, `UE_theme`, `UE_tjx`, `UE_ldx`, `UE_mailCheck`, `UE_sfz`, `UE_qq`, `UE_phone`, `UE_truename`, `UE_activeTime`, `UE_stop`, `UE_toActive`, `UE_drpd`, `zbqx`, `zbzh`, `ybhe`, `zsbhe`, `email`, `jihuouser`, `btbdz`, `pin`, `mz`, `xin`, `weixin`, `lx_weixin`, `zfb`, `yhmc`, `zhxm`, `yhzh`, `tz_leiji`, `date_leiji`, `jl_he`, `tj_he`, `jl_he1`, `tj_he1`, `pp_user`, `tx_leiji`, `tx_date`, `tj_num`, `levelname`, `isNew`, `tdnode`, `dongjie`) VALUES
(32, '', 'niuniu', 'admin@qq.com', 0, 'admin@qq.com', '0', '', 1, '', '5c67af1abce23ba41992576d94a3041b', '', '', '', '', '', '', '2016-05-30 18:41:37', '59.51.60.10', '2016-05-30 19:16:41', '', NULL, NULL, 0, 0, 0, NULL, '0', '22000', 0, NULL, '5c67af1abce23ba41992576d94a3041b', 'BC金融', NULL, NULL, '0', '', '', '13285087184', '妞妞', '2016-05-30 20:01:52', 1, 0, NULL, 0, NULL, '0.0000', '0.0000', '', '', '0', NULL, NULL, NULL, '系统帐号（周恒）', NULL, 'mofanwo@foxmail.com', '系统帐号', NULL, '系统帐号', '0', NULL, '0', '0', '0', '0', '778899', '0', NULL, 5, 'B0', 1, 1, 0),
(33, '', '778899', 'niuniu', 0, 'niuniu', '0', '', 1, '', 'e10adc3949ba59abbe56e057f20f883e', 'q1', NULL, NULL, '不知道', NULL, NULL, '2016-05-30 19:02:16', '59.51.60.10', '2016-07-07 09:32:56', '', NULL, NULL, 0, 0, 0, NULL, '0', '0', 0, NULL, '5c67af1abce23ba41992576d94a3041b', '成成', NULL, NULL, '0', '', '', '13285087184', '成成', '2016-07-07 10:07:02', 1, 0, NULL, 0, NULL, '0.0000', '0.0000', '', '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, '0', '0', '0', '0', NULL, '0', NULL, 0, 'B0', 1, 1, 0),
(34, '', 'ab123456', 'niuniu', 0, 'niuniu', '0', '', 1, '', '5c67af1abce23ba41992576d94a3041b', 'q2', NULL, NULL, '不知道', NULL, NULL, '2016-05-30 19:11:57', '59.51.60.10', '2016-05-30 20:12:48', '', NULL, NULL, 0, 0, 1, NULL, '0', '0', 0, NULL, '5c67af1abce23ba41992576d94a3041b', '小白', NULL, NULL, '0', NULL, NULL, '17069882035', '小白', '2016-05-30 20:12:48', 1, 0, NULL, 0, NULL, '0.0000', '0.0000', NULL, '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '50000', '2016-05-30 19:12:47', '0', '0', '0', '0', 'niuniu', '0', NULL, 2, 'B1', 0, 0, 0),
(35, '', 'wanggang', 'niuniu', 0, 'niuniu', '0', '', 1, '', 'e10adc3949ba59abbe56e057f20f883e', 'q1', NULL, NULL, '不知道', NULL, NULL, '2016-05-30 19:15:07', '59.51.60.10', '2016-05-30 19:15:32', '', NULL, NULL, 0, 0, 0, NULL, '0', '0', 0, NULL, 'e10adc3949ba59abbe56e057f20f883e', '成成大哥', NULL, NULL, '0', NULL, NULL, '15200555557', '成成大哥', NULL, 1, 0, NULL, 0, NULL, '0.0000', '0.0000', NULL, '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '50000', '2016-05-30 19:15:39', '0', '0', '0', '0', 'niuniu', '0', NULL, 0, 'B0', 1, 1, 0),
(36, '', 'ab12345', 'ab123456', 0, 'ab123456', '0', '', 1, '', 'e10adc3949ba59abbe56e057f20f883e', 'q2', NULL, NULL, '不知道', NULL, NULL, '2016-05-30 19:16:16', '59.51.60.10', '2016-05-30 19:56:57', '', NULL, NULL, 0, 0, 1, NULL, '0', '0', 0, NULL, 'e10adc3949ba59abbe56e057f20f883e', '小胖', NULL, NULL, '0', '', '', '18684588806', '小胖', '2016-05-30 19:42:40', 1, 0, NULL, 0, NULL, '0.0000', '0.0000', '', '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '100000', '2016-05-30 19:16:49', '0', '0', '0', '0', 'niuniu', '0', NULL, 1, 'B1', 0, 0, 0),
(37, '', 'ab1234', 'ab12345', 0, 'ab12345', '0', '', 1, '', '9cbf8a4dcb8e30682b927f352d6559a0', 'q3', NULL, NULL, '不知道', NULL, NULL, '2016-05-30 19:33:22', '59.51.60.10', '2016-05-30 23:55:07', '', NULL, NULL, 0, 0, 1, NULL, '0', '0', 0, NULL, '9cbf8a4dcb8e30682b927f352d6559a0', '小大大', NULL, NULL, '0', '', '', '17775619520', '小大大', NULL, 1, 0, NULL, 0, NULL, '0.0000', '0.0000', '', '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '50000', '2016-05-30 19:33:47', '0', '0', '0', '0', 'niuniu', '0', NULL, 0, 'B1', 1, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `rrhbt2t8888_useraddr`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_useraddr` (
...
--
-- 表的结构 `rrhbt2t8888_userget`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_userget` (
...
--
-- 表的结构 `rrhbt2t8888_usergroup`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_usergroup` (
...
--
-- 表的结构 `rrhbt2t8888_userinfo`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_userinfo` (
...
--
-- 表的结构 `rrhbt2t8888_userjyinfo`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_userjyinfo` (
...
--
-- 表的结构 `rrhbt2t8888_userlevel`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_userlevel` (
...
--
-- 表的结构 `rrhbt2t8888_user_jj`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_user_jj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user` varchar(255) DEFAULT NULL,
...
--
-- 表的结构 `rrhbt2t8888_user_jl`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_user_jl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user` varchar(255) DEFAULT NULL,
...
--
-- 表的结构 `rrhbt2t8888_zsbyg_dd`
--

CREATE TABLE IF NOT EXISTS `rrhbt2t8888_zsbyg_dd` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
