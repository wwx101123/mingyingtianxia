...
<body>
  ...
  <tr>
   ...
   <input name="user" type="text" class="dfinput" id="user" />
    ...
    <td align="right"><a href="/shi.php/Home/Index/ppdd_list/cz/0/">交易中</a> <a href="/shi.php/Home/Index/ppdd_list/cz/1/">交易成功</a></td>
  </tr>
  <tr>
    ...
    <table class="tablelist">
        ...
        <td>
      <?php if($v["ts_zt"] == 1): ?>未投诉<?php endif; ?>
      <?php if($v["ts_zt"] == 2): ?>未收到款投诉<?php endif; ?>
			<?php if($v["ts_zt"] == 1): ?>已投诉<?php endif; ?></td>
        <td><?php echo ($v["date"]); ?></td>
        <td><a href="/shi.php/Home/Index/ts1_list_cl/id/<?php echo ($v["id"]); ?>/">重新匹配</a></td>
