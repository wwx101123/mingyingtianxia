...
<body>
    ...
    <b><?php echo (session('adminuser')); ?>，欢迎使用信息管理系统</b><a href="/shi.php/Home/Index/adminlist">帐号设置</a>    </div>
    ...
    <ul class="umlist">
    <li><small>系统开关:<?php if($zt["zt"] == '0'): ?><a href="/shi.php/Home/Index/gb">关闭系统</a>
      <?php else: ?><a href="/shi.php/Home/Index/kq">开启系统</a><?php endif; ?><br />
