...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
      <form id="form1" name="form1" method="post" action="/shi.php/Home/Index/jbzscl">
    ...
    <ul class="forminfo"><li><label>赠送类型</label><cite><input name="lx" type="radio" value="jb" checked="checked" />
      金币&nbsp;&nbsp;&nbsp;&nbsp;
      <input name="lx" type="radio" value="dongjie" />
      冻结钱包&nbsp;&nbsp;&nbsp;&nbsp;
        <!--
      <input name="lx" type="radio" value="zsb" />
      钻石币--></cite></li>
    ...
    <li><label>&nbsp;</label><input name="" type="submit" class="btn" value="确认保存"/></li>
	 ...
	 <table class="tablelist">
		 ...
		 <td><?php echo ($v["ug_account"]); ?></td>
		   <td><?php echo ($v["ug_gettime"]); ?></td>
		    <td>
			 ...
			 <?php if($v["ug_type"] == 'dongjie'): ?>金币<?php echo ($v["ug_money"]); endif; ?>
        ...
        <td>
		 ...
		 <?php if($v["ug_type"] == 'dongjie'): ?>金币<?php echo ($v["ug_balance"]); endif; ?>
