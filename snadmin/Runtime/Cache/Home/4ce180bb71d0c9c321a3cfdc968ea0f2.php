...
<body style="background:url(/sncss/images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
	 <li><a href="/shi.php/Home/Index/df1" target="rightFrame" class="selected"><img src="/sncss/images/icon01.png" title="工作台" /><h2>后台首页</h2></a></li>
   <!--
	...
	<li><a href="/shi.php/Home/Index/adminlist"  target="rightFrame"><img src="/sncss/images/icon03.png" title="管理员管理" /><h2>管理员管理</h2></a></li>
...
<!--    <li><span><img src="/sncss/images/help.png" title="帮助"  class="helpimg"/></span><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>-->
    <li><a href="/shi.php/Home/Login/logout" target="_parent">退出</a></li>
    </ul>
