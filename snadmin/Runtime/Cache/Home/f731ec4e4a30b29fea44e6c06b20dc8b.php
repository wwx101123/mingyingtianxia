...
<!--     <div class="tools">
    	 ...
    	 <form id="form1" name="form1" method="post" action="/shi.php/Home/Index/userlist">
   ...
   <input name="user" type="text" class="dfinput" id="user" />
    ...
    <table class="tablelist">
        ...
        <td><a href="/shi.php/Home/Index/tixian_xg/id/<?php echo ($v["id"]); ?>" class="tablelink">修改状态</a></td>
