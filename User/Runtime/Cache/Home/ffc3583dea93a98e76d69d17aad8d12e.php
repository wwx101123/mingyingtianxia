...
header .head_top_log .top_content_log .right_text_log{
	width: 100%;
                  ...
                  <div class="clockWrap">
                    <div class="container clearfix">
                      <div class="pull-left" id="userRank">
                        当日盈利：静态余额[<?php echo ((isset($log_money) && ($log_money !== ""))?($log_money):0); ?>] 推荐奖[<?php echo ((isset($log_tjx) && ($log_tjx !== ""))?($log_tjx):0); ?>]领导奖[<?php echo ((isset($log_ldx) && ($log_ldx !== ""))?($log_ldx):0); ?>]排单币[<?php echo ((isset($log_code) && ($log_code !== ""))?($log_code):0); ?>]激活码[<?php echo ((isset($log_pai) && ($log_pai !== ""))?($log_pai):0); ?>]
                      </div>
                    </div>
                  </div>
                  <div class="container">
                              ...
                              class="form-horizontal margin-none" id="provide_help">
                                ...
                                <div class="widget-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                  <?php  $tgxz = explode(",",C('tgxz')); foreach($tgxz as $k=>$v): ?>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input name="sh" type="text" id="sh" class="form-control ">
																						<p class="help-block">您的排单币余额为：<strong class="green"><?php if($pin_zs): echo ($pin_zs); else: ?>0<?php endif; ?></strong></p>
																																</div>
									</div>
