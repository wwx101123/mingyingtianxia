      ...
      $.ajax({
          ...
          success : function(data, textStatus) {
            ...
            //alert(data.nr);
			  ...
			  $(".zTreeDemoCount").html("直推共<?php echo ($count); ?>人,团队共"+zNodes1.length+"人;");
            } else {
              alert(data.data);
            }
...
<div class="formbody">
  ...
  <div style="font-size:9pt;">
    <form action="" method="get">
      ...
      我的家谱 : <input id="user" name="user" type="text"> 
            ...
            <div class="widget-body innerAll overthrow">
              <table class="table table-bordered table-primary">
                ...
                <tbody>                
                  ...
                  <td>
                    <?php if($v['ue_check']): ?><font color="green">已激活</font>
                    <?php else: ?>
                      <font color="red">未激活</font><?php endif; ?>
                  </td>
                  <td>
                    <?php if($v['ue_check']): ?>--
                    <?php else: ?>
                      <a href="<?php echo U('active?user='.$v['ue_account']);?>">激活</a><?php endif; ?>
                  </td>
