...
<!-- Main Wrapper -->
 ...
 <p><strong>订单号码:R<span id="order_id"><?php echo ($ppddxx["id"]); ?></span></strong></p>
                ...
                <p>2016人均财富会员请求援助总金额为:<font id="amount_order" color="#FF0000"><?php echo ($ppddxx["jb"]); ?></font>人民币</p>
                ...
                <p><strong>接收者:<font id="receiver_lid"><?php echo ($g_user["ue_theme"]); ?></font>, 手机:<font class="receiver_phone"><?php echo ($g_user["ue_phone"]); ?></font>,联系微信:<font class="receiver_wechat_contact"><?php echo ($g_user["weixin"]); ?></font></strong></p>
                <p><strong>接收者经理:<font id="receiver_manager_lid"><?php echo ($g_user_t["ue_theme"]); ?></font>,接收者经理手机:<font id="receiver_manager_phone"><?php echo ($g_user_t["ue_phone"]); ?></font>,联系微信:<font class="receiver_manager_wechat_contact"><?php echo ($g_user_t["weixin"]); ?></font></strong></p>

                <p><strong>发送者:<font id="sender_lid"><?php echo ($p_user["ue_theme"]); ?></font>, 手机:<font id="sender_phone"><?php echo ($p_user["ue_phone"]); ?></font>,联系微信:<font id="sender_wechat_contact"><?php echo ($p_user["weixin"]); ?></font></strong></p>
				
                <p><strong>发送者经理:<font id="sender_manager_lid"><?php echo ($p_user_t["ue_theme"]); ?></font>,发送者经理手机:<font id="sender_manager_phone"><?php echo ($p_user_t["ue_phone"]); ?></font>,联系微信:<font id="sender_manager_wechat_contact"><?php echo ($p_user_t["weixin"]); ?></font></strong></p>
