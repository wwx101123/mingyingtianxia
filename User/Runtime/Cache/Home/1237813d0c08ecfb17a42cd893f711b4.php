    ...
    <div class="container">
        <ul class="nav navbar-nav navbar-right" role="sub-navigation">
            <li class="dropdown" id="lang_nav">
                <a href="/">
                    <span class="language-text">返回</span>
                </a>
            </li>
        </ul>
    </div>
                    ...
                    <div class="widget widget-body-white padding-none">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="form-group">
                               <label class="col-md-3 control-label">手机号码<span class="ast">*</span></label>
                                <div class="input-group col-md-9">
                                    ...
                                    <?php if(C('phonecheck')): ?><span class="input-group-btn"> <input type="button" value="发送" onClick="time(this);" class="btn btn-primary"></span><?php endif; ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9"><input class="form-control" id="password2" name="active"  type="text"></div>
                            </div>
                            <div class="form-group">
