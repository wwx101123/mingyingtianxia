            ...
            <div class="row">
                ...
                <div class="col-md-6 tablet-column-reset">
                    <div class="widget widget-body-white padding-none">
                        ...
                        <form class="form-horizontal margin-none" id="loginForm" method="post" action="<?php echo U('Home/Info/xgzlcl');?>">
                            <div class="widget-body">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="" value="<?php echo ($userData['ue_phone']); ?>" id="mobile" class="form-control" name="phone" required readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo ($userData['zfb']); ?>" id="alipay" class="" name="alipay" <?php if(!empty($userData['zfb'])): ?>readonly<?php endif; ?>>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">开户行</label>
                                    <div class="col-md-8">
                                        <input type="" value="<?php echo ($userData['zbzh']); ?>" id="" class="form-control" name="zbzh" required >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">银行名称</label>
                                    <div class="col-md-8">
                                        <input type="" value="<?php echo ($userData['yhmc']); ?>" id="" class="form-control" name="bank_name" required <?php if(!empty($userData['yhmc'])): ?>readonly<?php endif; ?>>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label">银行账户号码</label>
                                    <div class="col-md-8">
                                        <input type="" value="<?php echo ($userData['yhzh']); ?>" id="" class="form-control" name="bank_number" required <?php if(!empty($userData['yhzh'])): ?>readonly<?php endif; ?>>
                                    </div>
                                </div>
                                                                <div class="form-group">
...
<script>
    ...
    function time(o) {
        ...
        $.post("<?php echo U('Reg/sendPhone');?>", { phone: $("#mobile").val() }, function(msg) { alert("验证码已经发送，注意查收"); });
	...
	function Submit_XGMM(){
		...
		var xmmqr = $("#xmmqr").val();
		$.ajax( {
			url:"<?php echo U('Info/xgyjmmcl');?>",// 跳转到 action
			data:{
				xmm : xmm,
				ymm : ymm,
				xmmqr : xmmqr,
